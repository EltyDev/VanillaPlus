...
public class ObsiBoot {
	...
	public static void registerCraft() {
        ...
        ItemStack ObsiArmor = new ItemStack(Material.LEATHER_BOOTS);
        ...
        ObsiMeta.setDisplayName("§6Obsidian Boots");
        ObsiMeta.setLore(Arrays.asList(" ", "§6§lLEGENDARY"));
        ObsiArmor.setItemMeta(ObsiMeta);

        NamespacedKey key = new NamespacedKey(Main.getPlugin(Main.class), "obsidianboots");
