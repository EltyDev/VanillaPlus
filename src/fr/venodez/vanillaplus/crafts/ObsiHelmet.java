...
public class ObsiHelmet {
	...
	public static void registerCraft() {
        ...
        ItemStack ObsiArmor = new ItemStack(Material.LEATHER_HELMET);
        ...
        ObsiMeta.setDisplayName("§6Obsidian Helmet");
        ObsiMeta.setLore(Arrays.asList(" ", "§6§lLEGENDARY"));
        ObsiArmor.setItemMeta(ObsiMeta);

        NamespacedKey key = new NamespacedKey(Main.getPlugin(Main.class), "obsidianhelmet");
